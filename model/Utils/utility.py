...
def create_models(base_model='VGG19', device=None, args=None):
    ...
    # Spatial Encoder
    models['Spatial_Encoder'] = STTAE.Encoder(base_model=base_model, frame_diff=args.fd, args=args)
    # Temporal Encoder_Decoder
    models['Temp_EncDec'] = STTAE.VariationalRAE(configs.Configs, batch_size=args.batch_size, device=device, args=args)
